...
def build_model(cfg):
    ...
    # - aqt deformable detr (uda)
    elif cfg.model.name == 'aqt_deformable_detr':
        from .aqt import build_aqt_deformable_detr
        return build_aqt_deformable_detr(cfg, backbone)
    else:
